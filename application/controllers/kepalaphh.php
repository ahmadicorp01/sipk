...
class Kepalaphh extends CI_Controller {
	...
	{	
		...
		$data['notifikasi_n'] = $i;
		$data['admin'] = $this->m_pengguna->get_pengguna_admin();
	...
	public function lapor_keluhan()
	{
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('tambah_keluhan_kepala',$data);
		$this->load->view('footer');
	}
	...
	{	
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('tampil_laporan_kepala',$data);
		$this->load->view('footer');
	}
	...
	public function tambah_kategori()
	{
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('tambah_kategori_kepalaphh');
		$this->load->view('footer');
	}
	...
	public function lihat_kategori()
	{
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('tampil_kategori_kepalaphh',$data);
		$this->load->view('footer');
	}
	...
	public function edit_kategori($id)
	{
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('edit_kategori_kepalaphh',$data);
		$this->load->view('footer');
	}
	...
	{	
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('tampil_cetak_laporan',$data);
		$this->load->view('footer');
	}
	public function cetak_laporan($varbulan,$vartahun)
	{	
		// $varbulan = '03';
		// $vartahun = '2019';
		$data['hasil'] = $this->m_laporan->get_laporan_by_kategori_and_pengguna($varbulan,$vartahun);
	...
	{	
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header', $data);
		$this->load->view('tampil_pengguna_kepala',$data);
		$this->load->view('footer');
	}
	...
	public function edit_pengguna($id)
	{
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('edit_pengguna_kepala',$data);
		$this->load->view('footer');
	}
	...
	public function tambah_pengguna()
	{
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header',$data);
		$this->load->view('tambah_pengguna_kepala');
		$this->load->view('footer');
	}
	...
	{	
		...
		$this->load->view('sidebar_admin');
		$this->load->view('header', $data);
		$this->load->view('tampil_ktp_pengguna_kepala',$data);
		$this->load->view('footer');
	}
