            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url ('api/tambah_laporan_kepala') ?>" method="post">
                        ...
                        <div class="form-group"><label for="pengguna" class=" form-control-label">Nama</label>
                          ...
                          <input type="text" style="width: 40%" name="judul_keluhan" required class="form-control">
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea style="width: 40%" name="keluhan" required class="form-control"></textarea>
                          </div>
