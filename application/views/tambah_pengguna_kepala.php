            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url ('api/tambah_pengguna_kepala') ?>" method="post">
                      <div class="form-group"><label for="nama_pengguna" class=" form-control-label">NIP Pengguna</label>
                          <input type="text" style="width: 40%" maxlength="18" name="nip_pengguna" required class="form-control">
                            </div>
