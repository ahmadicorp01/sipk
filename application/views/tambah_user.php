          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url ('api/tambah_user_admin') ?>" method="post">
                        ...
                        <div class="form-group"><label for="Username" class=" form-control-label">Username</label>
                          <input type="text" name="username" required style="width: 30%" class="form-control">
                        </div>
                        <div class="form-group"><label for="Password" class=" form-control-label">Password</label>
                          <input type="text" name="password" required style="width: 30%" class="form-control">
                        </div>
                        <div class="form-group">
