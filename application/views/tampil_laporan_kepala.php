                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <?php if ($u->nip_pengguna == $this->session->userdata('nip_pengguna')) { ?>
                            ...
                            <td colspan="2" align="center"><a href="<?php echo base_url('kepalaphh/tanggapi_keluhan/'). $u->id_laporan;?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-print">Lihat</span></a></td>

                          <?php } else { ?>

                            <td colspan="2" align="center"><a href="<?php echo base_url('kepalaphh/tanggapi_keluhan/'). $u->id_laporan;?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-print"><?php echo ($u->laporan_status == 3 ) ? "Lihat" : "Tanggapi Keluhan"?></span></a></td>
                          <?php } ?>
                        </tr>
                        <?php } ?>
