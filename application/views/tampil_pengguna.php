          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-4">
               ...
               <a href="<?php echo base_url('admin/tambah_pengguna/')?>" style="float:right;" class="btn btn-primary">Tambah Pengguna</a>
               <br/><br/>
                ...
                <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo base_url('admin/edit_pengguna/') . $u->nip_pengguna; ?>" class="btn btn-primary btn-sm">
                        <span class="fa fa-edit"></span></a>
                        <a href="<?php echo base_url('api/delete_pengguna_admin/') . $u->nip_pengguna; ?>" class="btn btn-danger btn-sm"
